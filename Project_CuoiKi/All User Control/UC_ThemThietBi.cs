...
namespace Project_CuoiKi.All_User_Control
{
    public partial class UC_ThemThietBi : UserControl
    {
        ...
        private void Load_DataGridView()
        {
            ...
            dgridthietbi.Columns[0].HeaderText = "Mã Loại Thiết Bị";
            ...
            dgridthietbi.Columns[0].Width = 100;
            dgridthietbi.Columns[1].Width = 300;
        ...
        private void DataGridView_Click(object sender, EventArgs e)
        {
            ...
            str = "SELECT MaLoaiTB FROM ThietBi WHERE MaThietBi = N'" + txtmathietbi.Text + "'";
            cboloaithietbi.Text = functions.getfieldvalues(str);
            str = "SELECT MaNhomTB FROM ThietBi WHERE MaThietBi = N'" + txtmathietbi.Text + "'";
            cboloaithietbi.Text = functions.getfieldvalues(str);
            txtmanhacungcap.Text = dgridthietbi.CurrentRow.Cells["MaNCC"].Value.ToString();
            txtgia.Text = dgridthietbi.CurrentRow.Cells["MaNCC"].Value.ToString();
            txtbaohanh.Text = dgridthietbi.CurrentRow.Cells["Gia"].Value.ToString();
        ...
        private void ResetValues()
        {
            ...
            txttenthietbi.Text = "";
            cboloaithietbi.Text = "";
            cbonhomthietbi.Text = "0";
            txtmanhacungcap.Text = "0";
            txtgia.Text = "0";
